...
<template>
  ...
  >
    ...
    <!-- Bottom Section -->
    <div v-if="user" class="p-2 border-t border-white/10 space-y-1">
      <button 
        @click="handleLogout"
        class="group flex items-center w-full py-3 px-3 rounded-xl transition-all duration-200 hover:bg-red-500 relative"
        title="Logout"
      >
        <svg 
          xmlns="http://www.w3.org/2000/svg" 
